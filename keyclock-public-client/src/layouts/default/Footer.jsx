...
const Footer = ()=>{
    return <footer id="page-footer" className="bg-gray-200">
        <div className="text-center text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 py-16">
            <div className="space-y-10">
                ...
                <nav className="space-x-2 sm:space-x-4">
                    <Link to="/" className="font-medium text-gray-900 hover:text-gray-500">
                        About
                    </Link>
                    <Link to="/" className="font-medium text-gray-900 hover:text-gray-500">
                        Terms of Service
